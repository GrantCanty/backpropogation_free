"""State-matched analytic comparison for the recurring-domain experiment."""
...
from experiments.legacy import evaluate_digits
from experiments.cpam_capstone import (
    MemoryCapstoneConfig,
    RegimeName,
    build_learner as build_capstone_learner,
    phase_metrics,
    regime_splits,
    run_model as run_capstone_model,
    summary,
)
...
def run_analytic_memory_comparison(
    ...
    budget_bytes = {
        "cpam32": build_capstone_learner(
            "managed_memory_32", cpam_config, 0
        ).state_nbytes,
        "cpam64": build_capstone_learner(
    ...
    for family in FAMILIES:
        ...
        for option in options:
            ...
            for seed in config.development_seeds:
                ...
                regimes = regime_splits(original, development_config, seed)
            ...
            trials.append(
                {
                    "parameters": option,
                    "structural_capacity": capacity,
                    "selection_score": summary(scores),
                    "primary_metrics": {
                        metric: summary(
    ...
    for seed in config.test_seeds:
        ...
        regimes = regime_splits(original, cpam_config, seed)
